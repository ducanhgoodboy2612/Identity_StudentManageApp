        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmed = table.Column<int>(type: "NUMBER(1)", nullable: false), // Changed to NUMBER(1)
                    PasswordHash = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    SecurityStamp = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    PhoneNumberConfirmed = table.Column<int>(type: "NUMBER(1)", nullable: false), // Changed to NUMBER(1)
                    TwoFactorEnabled = table.Column<int>(type: "NUMBER(1)", nullable: false), // Changed to NUMBER(1)
                    LockoutEnd = table.Column<DateTimeOffset>(type: "TIMESTAMP(7) WITH TIME ZONE", nullable: true),
                    LockoutEnabled = table.Column<int>(type: "NUMBER(1)", nullable: false), // Changed to NUMBER(1)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departments_n", x => x.DepartmentID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.UserId,
                        principalSchema: "STUDENT_MANAGE_DB",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseID = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    LecturerID = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    RemainSlots = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Semester = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Year = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
